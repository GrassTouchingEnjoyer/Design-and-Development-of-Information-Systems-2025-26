...
public class BillsView extends JPanel {
    ...
    public void addBill(String issuer, double amount,String code,String date, Runnable onPay) {
        ...
        JLabel label = new JLabel(issuer + " - " + 
        String.format("%.2f €", amount) + " Bill code: " + code + "  until " + date);
        label.setFont(new Font("Arial", Font.PLAIN, 16));
        label.setBorder(BorderFactory.createEmptyBorder(0, 10, 0, 0)); // padding αριστερά

        JButton payButton = new JButton("Πληρωμή");
